            ...
            <>
              ...
              {method === 'Ojol' && (
                <div className="mb-6 p-4 border border-orange-200 dark:border-orange-500/30 bg-orange-50 dark:bg-orange-500/10 rounded-2xl animate-in fade-in slide-in-from-top-2 duration-300">
                  ...
                  <input type="text" placeholder="Masukkan nomor order..." value={orderNumber || ''} onChange={(e) => setPaymentModal({ ...paymentModal, orderNumber: e.target.value })} className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 focus:outline-none focus:border-orange-600 dark:focus:border-orange-500 bg-white dark:bg-slate-900 text-sm font-bold transition-colors" />
                </div>
              )}
                ...
                <div className="text-center bg-slate-50 dark:bg-slate-950 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 animate-in fade-in zoom-in-95 duration-300">
                  {status === 'pending' ? (
                    ...
                    <>
                      ...
                      <h3 className="font-heading font-bold text-slate-800 dark:text-slate-100 mb-2">Pembayaran Terverifikasi</h3>
                      <p className="text-sm text-slate-500 dark:text-slate-400">Anda dapat mencetak struk sekarang.</p>
                    </>
                  )}
                </div>
              )}
            ...
            <>
              ...
              {splitRemaining > 0 && (
                <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 space-y-4">
                  ...
                  <div className="flex gap-2">
                    <button onClick={() => setPaymentModal({ ...paymentModal, amountPaid: splitRemaining.toString() })} className="flex-1 py-1.5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-[10px] font-bold rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700">Uang Pas Sisa</button>
                  </div>
                </div>
              )}
            </>
