...
const handleAddVoucher = () => {
  // Pastikan kuota juga wajib diisi (opsional, sesuaikan dengan kebutuhan)
  if (!newVoucherCode || !newVoucherDiscount || !newVoucherQuota) return triggerAlert('Lengkapi data voucher termasuk kuota!');
  ...
  setVouchers([...vouchers, {
    ...
    quota: Number(newVoucherQuota) // 2. SIMPAN DATA KUOTA
  }]);

  setNewVoucherCode('');
  setNewVoucherDiscount('');
  setNewVoucherMinPurchase('');
  setNewVoucherQuota(''); // 3. RESET STATE KUOTA
