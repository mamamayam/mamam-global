            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 flex flex-col h-full min-h-[400px]">
              ...
              <div className="flex gap-2 mt-1">
                <button 
                  ...
                  className={`flex-1 py-3 text-white rounded-xl text-sm font-bold shadow-md transition-all duration-300 hover:-translate-y-0.5 flex items-center justify-center gap-2 ${editingVoucherId ? 'bg-blue-600 hover:bg-blue-700' : 'bg-orange-600 hover:bg-orange-700'}`}
                >
                ...
                {editingVoucherId && (
                  <button 
                    ...
                    className="px-4 py-3 bg-slate-200 hover:bg-slate-300 text-slate-700 rounded-xl text-sm font-bold transition-all duration-300"
                  >
                    Batal
                  </button>
                )}
